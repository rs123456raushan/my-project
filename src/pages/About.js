                        ...
                        <div className="about-us-section-top">
                            ...
                            <p>
                                <span>Since 2010, we are on a
                                    ...
                                    them to become change catalysts in their communities.</span>
                                <span>We are constantly exploring boundaries and extending our
                                    ...
                                    Punjab, Haryana, Rajasthan, Gujarat.</span>
                            </p>
                        </div>
                    </div>
                                ...
                                <div className="col-md-6">
                                    <div className="right-content">
                                        <p>
                                            ...
                                            rupees per day. This segment has been the victim of
                                            unequal access - unequal access to capital, unequal
                                            access to healthcare, unequal access to a better life.
                                            <br />
                                            At our core, we aspire to serve and uplift this very
                                            segment by providing them with the essential support
                                            they need to break free from the cycle of inequality.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="founder-section-right">
                                <p>
                                    <span>We are proud and humbled to be one of pioneers of the Indian
                                        ...
                                        <strong>With 30 lakh women borrowers served to date,</strong>
                                        we are breaking barriers that have hindered their progress for
                                        too long. These women are not just borrowers; they are
                                        courageous entrepreneurs with dreams and aspirations,
                                        deserving equal opportunities.</span><br /><br />
                                    <span>Our mission extends beyond providing loans; it's about
                                        creating a ripple effect of empowerment.
                                        <strong>When we empower a woman, we empower an entire family, a
                                            community, and eventually, a nation</strong>. With unwavering passion, we support these women in
                                        starting
                                        businesses, provide them access to better healthcare and build
                                        a brighter future.</span><br /><br />
                                    <span>We are immensely proud of our impact so far, and even more
                                        energized for the impact that we are yet to create.</span>
                                </p>
                            </div>
                        </div>
                    </div>
