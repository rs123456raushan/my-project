              ...
              <div className="person-card">
                ...
                <div className="person-card-text">
                  ...
                  <p className="person-description">
                    Sunil Sachdeva is a seasoned entrepreneur with a diverse business portfolio spanning healthcare, finance, real estate, and technology. He is the co-founder and director of Medanta, one of India’s largest multi-specialty hospitals <i>(2400+ installed beds)</i> with five hospitals in Delhi, Gurugram, Indore, Ranchi, Patna and Lucknow. In 2010, he established SVCL with a clear mission to facilitate financial inclusion for the enterprising rural women in India. His unwavering vision, boundless energy, and commitment to innovation have positioned him as a standout leader, propelling SVCL's growth story forward. His entrepreneurial journey has been instrumental in transforming access to quality healthcare and promoting financial inclusion in India.
                  </p>
                </div>
              </div>
              <div className="person-card">
