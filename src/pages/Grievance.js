              ...
              <div className="value-cards-wrapper grievance-mechanism-card-wrapper">
                <div className="value-card grievance-mechanism-card">
                  <div className="value-card-body grievance-mechanism-card-body">
                    ...
                    <p>
                      Contact the respective Branch Manager. Phone number and
                      the address of the Branch office are mentioned in the
                      passbook.
                    </p>
                  </div>
                </div>
                <div className="value-card grievance-mechanism-card">
                  <div className="value-card-body grievance-mechanism-card-body">
                    ...
                    <p>
                      ...
                      customer can reach out to the grievance officer.
                      <br />
                      <br />
                ...
                <div className="value-card grievance-mechanism-card">
                  <div className="value-card-body grievance-mechanism-card-body">
                    ...
                    <p>
                      ...
                      customer can reach out to the CBO <br />
                      <br />
                      CBO: Mr. Anand Tripathi
                      <br />
                      Email : &nbsp;
                      <a href="#" target="_blank">
                        cbo@svcl.in
                      ...
                      <br />
                      Address: 5th Floor, Tower B, SAS Tower, Medanta Sector-38,
